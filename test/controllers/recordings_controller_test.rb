...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference("Recording.count") do
      post recordings_url, params: { recording: { data: @recording.data, device_id: @recording.device_id } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { data: @recording.data, device_id: @recording.device_id } }
