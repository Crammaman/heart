...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference("Device.count") do
      post devices_url, params: { device: { config: @device.config, name: @device.name, type: @device.type } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { config: @device.config, name: @device.name, type: @device.type } }
